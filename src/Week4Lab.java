...
public class Week4Lab {
	...
	public static void main(String[] args) {
		...
		//a StringBuilder is more efficient when you know you are going to be using a String that is going to be built up,
		//or changed multiple times. This is because when we concatenate to a String, this is creating a new String in memory.
		//Unlike StringBuilder which can be added to, or removed from before turning into a String at the end.
		...
		Set<String> startsWithE = findAllThatStartWith(set, 'E');
		for(String word : startsWithE)
		{
		...
		//create a map of string and string and add 3 items to it where the key of each is a word and the value is the definition of t he word
