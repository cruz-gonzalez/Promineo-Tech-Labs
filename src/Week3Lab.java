...
public class Week3Lab {
	...
	public static void main(String[] args) {
		...
		//part 2
		//write and test a method that takes a String name and prints out a greetings, this method returns nothing
		greet("Tom");
		greet("Sally");
		...
		//the first method will "do" something and the second will "return" something
		...
		//write and test a method that takes an array of String and returns true if the sum of letters for all string with an
